...
Start_SSR(){
	check_pid
	wget -O /etc/init.d/ssrmu "https://${vpn2}/ssrmu"
...
Install_SSR
wget -O /usr/bin/ssr https://${vpn2}/ssrmu.sh && chmod +x /usr/bin/ssr
wget -O /usr/bin/addssr https://${vpn2}/addssr.sh && chmod +x /usr/bin/addssr
wget -O /usr/bin/delssr https://${vpn2}/delssr.sh && chmod +x /usr/bin/delssr
wget -O /usr/bin/renewssr https://${vpn2}/renewssr.sh && chmod +x /usr/bin/renewssr
