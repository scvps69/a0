...
wget -O /etc/accel-ppp.conf "https://${vpn1}/accel.conf"
...
#input perintah sstp
wget -O /usr/bin/addsstp https://${vpn1}/addsstp.sh && chmod +x /usr/bin/addsstp
wget -O /usr/bin/delsstp https://${vpn1}/delsstp.sh && chmod +x /usr/bin/delsstp
wget -O /usr/bin/ceksstp https://${vpn1}/ceksstp.sh && chmod +x /usr/bin/ceksstp
wget -O /usr/bin/renewsstp https://${vpn1}/renewsstp.sh && chmod +x /usr/bin/renewsstp
rm -f /root/sstp.sh
